...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-016-linear-equation-x-3y-2z-2w-1680e009-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-016"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-016-linear-equation-x-3y-2z-2w-1680e009-v1",
      "problem_contract_sha256": "b3a0ca09838cdf0ce16984cda85288d7b9d89f169c051600076ab56aa39bb23d",
      "problem_id": "problem:um-green-016-linear-equation-x-3y-2z-2w-1680e009",
      "route_id": "route:um-green-016-linear-equation-x-3y-2z-2w-1680e009-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-016-linear-equation-x-3y-2z-2w-1680e009-source-fidelity-01",
      "graph_id": "graph:um-green-016-linear-equation-x-3y-2z-2w-1680e009-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-016-linear-equation-x-3y-2z-2w-1680e009-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-016-linear-equation-x-3y-2z-2w-1680e009-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the largest subset of $[N]$ with no solution to $x + 3y = 2z + 2w$ in distinct integers $x, y, z, w$?"
          },
          "statement_sha256": "f02d20b5330b27a73c9a00774174f4bac01cfe0640839c7b2f132bfcd631b55d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-016-linear-equation-x-3y-2z-2w-1680e009-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-016-linear-equation-x-3y-2z-2w-1680e009-root",
      "route_id": "route:um-green-016-linear-equation-x-3y-2z-2w-1680e009-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-016-838ee13743a2",
        "url": "https://www.unsolvedmath.com/problems/GREEN-016"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
